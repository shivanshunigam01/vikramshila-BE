...
class SinchIterator {
    ...
    async getNextPage(pageResult) {
        ...
        if (this.paginatedOperationProperties.pagination === api_client_1.PaginationEnum.TOKEN2) {
            const newParams = {
        ...
        if (this.paginatedOperationProperties.pagination === api_client_1.PaginationEnum.PAGE
            || this.paginatedOperationProperties.pagination === api_client_1.PaginationEnum.PAGE2
...
const createNextPageMethod = (apiClient, context, requestOptions, nextPageValue) => {
    ...
    switch (context.pagination) {
        case api_client_1.PaginationEnum.TOKEN:
            ...
            break;
        case api_client_1.PaginationEnum.TOKEN2:
            newParams = {
...
function hasMore(response, context) {
    ...
    if (context.pagination === api_client_1.PaginationEnum.TOKEN2) {
