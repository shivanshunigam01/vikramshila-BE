...
export declare class GroupsApi extends SmsDomainApi {
     ...
     */
    create(data: CreateGroupRequestData): Promise<Group>;
    /**
     * Delete a group
     ...
     */
    replace(data: ReplaceGroupRequestData): Promise<Group>;
    /**
     * Retrieve a group
     ...
     */
    get(data: GetGroupRequestData): Promise<Group>;
    /**
     * Update a group
     ...
     */
    update(data: UpdateGroupRequestData): Promise<Group>;
}
