 ...
 */
export type SinchClientParameters = Partial<UnifiedCredentials & MailgunCredentials & ServicePlanIdCredentials & ApplicationCredentials & ApiHostname & ApiPlugins>;
...
export declare enum SupportedSmsRegion {
    UNITED_STATES = "us",
    EUROPE = "eu",
    BRAZIL = "br",
    CANADA = "ca",
...
export declare const SmsRegion: {
    UNITED_STATES: SupportedSmsRegion.UNITED_STATES;
    EUROPE: SupportedSmsRegion.EUROPE;
    BRAZIL: SupportedSmsRegion.BRAZIL;
    CANADA: SupportedSmsRegion.CANADA;
    AUSTRALIA: SupportedSmsRegion.AUSTRALIA;
};
export declare enum SupportedVoiceRegion {
    DEFAULT = "",
    UNITED_STATES = "use1",
    EUROPE = "euc1",
    SOUTH_AMERICA = "sae1",
...
export declare const VoiceRegion: {
    DEFAULT: SupportedVoiceRegion.DEFAULT;
    UNITED_STATES: SupportedVoiceRegion.UNITED_STATES;
    EUROPE: SupportedVoiceRegion.EUROPE;
    SOUTH_AMERICA: SupportedVoiceRegion.SOUTH_AMERICA;
    SOUTHEAST_ASIA_1: SupportedVoiceRegion.SOUTHEAST_ASIA_1;
    SOUTHEAST_ASIA_2: SupportedVoiceRegion.SOUTHEAST_ASIA_2;
};
export declare enum SupportedFaxRegion {
    DEFAULT = "",
    UNITED_STATES = "use1",
    EUROPE = "eu1",
    SOUTH_AMERICA = "sae1",
...
export declare const FaxRegion: {
    DEFAULT: SupportedFaxRegion.DEFAULT;
    UNITED_STATES: SupportedFaxRegion.UNITED_STATES;
    EUROPE: SupportedFaxRegion.EUROPE;
    SOUTH_AMERICA: SupportedFaxRegion.SOUTH_AMERICA;
    SOUTHEAST_ASIA_1: SupportedFaxRegion.SOUTHEAST_ASIA_1;
    SOUTHEAST_ASIA_2: SupportedFaxRegion.SOUTHEAST_ASIA_2;
};
export declare enum SupportedConversationRegion {
    UNITED_STATES = "us",
    EUROPE = "eu",
    BRAZIL = "br"
}
export type ConversationRegion = SupportedConversationRegion | string;
export declare const ConversationRegion: {
    UNITED_STATES: SupportedConversationRegion.UNITED_STATES;
    EUROPE: SupportedConversationRegion.EUROPE;
    BRAZIL: SupportedConversationRegion.BRAZIL;
};
export declare enum SupportedMailgunRegion {
    DEFAULT = "",
    EUROPE = "eu"
}
export type MailgunRegion = SupportedMailgunRegion | string;
export declare const MailgunRegion: {
    DEFAULT: SupportedMailgunRegion.DEFAULT;
    EUROPE: SupportedMailgunRegion.EUROPE;
};
